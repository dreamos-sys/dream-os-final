...
1. **JANGAN membuka Issue publik.** Kirim laporan ke:  
   📧 **dreamos.sch.id@gmail.com** dengan subjek: `[SECURITY] - Deskripsi Singkat`

2. **Waktu respons:** Kami akan mengonfirmasi laporan dalam **2×24 jam** dan memberikan pembaruan berkala.

3. **Proses:** Setelah diverifikasi, kami akan:
   - Menentukan tingkat keparahan (Critical/High/Medium/Low)
   - Merilis patch dalam **7 hari** untuk Critical, **30 hari** untuk lainnya
   - Memberi kredit kepada pelapor (kecuali diminta anonim)

4. **Kebijakan:** Laporan yang diterima akan ditangani secara rahasia hingga patch dirilis. Kami tidak akan mengambil tindakan hukum terhadap peneliti keamanan yang bertindak dengan itikad baik.
