# 1. Masuk ke folder K3
mkdir -p ~/dream-live/workspaces/kabag_umum/modules/k3

# 2. Tembak kodenya (Paste kode K3 Module yang tadi di sini)
cat << 'EOF' > ~/dream-live/workspaces/kabag_umum/modules/k3/module.js
/**
